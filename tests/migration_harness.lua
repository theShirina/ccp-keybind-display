...
assertEqual(CCPKeybindDisplay.db.visual.width, nil, "retired preferred width removed")
...
assertEqual(CCPKeybindDisplay.db.schemaVersion, 5, "schema version recorded")
...
assertEqual(CCPKeybindDisplay.db.visual.width, nil, "retired width remains removed")
...
assertEqual(CCPKeybindDisplay.db.visual.width, nil, "old visual width is retired")
...
assertEqual(CCPKeybindDisplay.db.visual.width, nil, "schema-four width is removed")
